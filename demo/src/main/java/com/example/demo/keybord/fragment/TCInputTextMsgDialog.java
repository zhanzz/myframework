...
public class TCInputTextMsgDialog extends Dialog {
    ...
    public TCInputTextMsgDialog(Context context, int theme) {
        ...
        //修改下划线颜色
        messageTextView.getBackground().setColorFilter(0x00000000, PorterDuff.Mode.CLEAR);
...
//                            messageTextView.setText("");
        ...
        rldlgview.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View view, int i, int i1, int i2, int i3, int i4, int i5, int i6, int i7) {
                ...
                Log.e("zhang","isEqul="+(getWindow().getDecorView()==getWindow().getDecorView().getRootView()));
                Log.e("zhang","react="+r.top+";bottom="+r.bottom);
                Log.e("zhang","screenHeigh="+screenHeight);
                Log.e("zhang","rootView="+getWindow().getDecorView().getRootView().getClass().getSimpleName() );

                if (heightDifference <= UIHelper.dip2px(80) && mLastDiff > 0){
                    //imm.hideSoftInputFromWindow(messageTextView.getWindowToken(), 0);
                    dismiss();
                }else{
                    rldlgview.setTranslationY(-UIHelper.dip2px(20));
                }
