...
public class ActivityRefreshHeader extends ConstraintLayout implements RefreshHeader {
    ...
    public ActivityRefreshHeader(Context context) {
        this(context, null, 0);
    }

    public ActivityRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ActivityRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean isLoadActivity() {
        return isLoadActivity;
    }
}