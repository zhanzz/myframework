...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			...
			// attribute in XML");
			mClearDrawable = getResources().getDrawable(R.drawable.a_0);
		}
	...
	public void setClearIconVisible(boolean visible) {
		Drawable right = (visible&&isEnabled()&& isShowClear) ? mClearDrawable : null;
	...
	public void setNotEditableView(){
		setKeyListener(null);
		//设置省略号在结尾
