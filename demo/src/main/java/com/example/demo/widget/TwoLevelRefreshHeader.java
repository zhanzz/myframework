...
public class TwoLevelRefreshHeader extends InternalAbstract implements RefreshHeader/*, InvocationHandler*/ {
...
//    protected Method mRequestDrawBackgroundForHeaderMethod;
    ...
    public TwoLevelRefreshHeader(@NonNull Context context) {
        this(context, null);
    }

    public TwoLevelRefreshHeader(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoLevelRefreshHeader(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void onMoving(boolean isDragging, float percent, int offset, int height, int maxDragHeight) {
        ...
        if (isDragging) {
            if (percent >= mFloorRage && mEnableTwoLevel) {
                refreshKernel.setState(RefreshState.ReleaseToTwoLevel);
            } else if (percent < mRefreshRage) {
     ...
     */
    public TwoLevelRefreshHeader setRefreshHeader(RefreshHeader header) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setRefreshHeader(RefreshHeader header, int width, int height) {
        final ViewGroup thisGroup = this;
        if (header != null) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setMaxRage(float rate) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setEnablePullToCloseTwoLevel(boolean enabled) {
        final RefreshKernel refreshKernel = mRefreshKernel;
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setFloorRage(float rate) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setRefreshRage(float rate) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setEnableTwoLevel(boolean enabled) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setFloorDuration(int duration) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader setOnTwoLevelListener(OnTwoLevelListener listener) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader finishTwoLevel() {
        final RefreshKernel refreshKernel = mRefreshKernel;
        if (refreshKernel != null) {
     ...
     * @return TwoLevelHeader
     */
    public TwoLevelRefreshHeader openTwoLevel(boolean widthOnTwoLevelListener) {
        final RefreshKernel refreshKernel = mRefreshKernel;
        if (refreshKernel != null) {
            final OnTwoLevelListener twoLevelListener = mTwoLevelListener;
