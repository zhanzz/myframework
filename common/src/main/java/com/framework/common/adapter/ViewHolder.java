...
public class ViewHolder extends RecyclerView.ViewHolder
{
    ...
    public ViewHolder setImageByUrl(int viewId, String url) {
        final SimpleDraweeView mImageView = getView(viewId);
    ...
    public ViewHolder setImageByUrl(int viewId, String url,int width,int height) {
        ...
        if (!TextUtils.isEmpty(url)) {
            FrescoUtils.showThumb(url,imageView,width,height);
        }
        return this;
    }
    /****以下为辅助方法*****/
    ...
    public ViewHolder setGone(int loadingViewId, boolean visible) {
        View view = getView(loadingViewId);
        if(view!=null){
