...
public final class MyObservableCreate<T> extends Observable<T> {
    ...
    protected void subscribeActual(Observer<? super T> observer) {
        CreateEmitter<T> parent = new CreateEmitter<T>(observer,source);
    ...
    static final class CreateEmitter<T>
        ...
        final MyObservableOnSubscribe<T> source;
        CreateEmitter(Observer<? super T> observer,MyObservableOnSubscribe<T> source) {
