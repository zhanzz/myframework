...
public class TitleView extends RelativeLayout {
    ...
    private int defaultTitleSize = 18;
    ...
    private void initLeftTextView (Context context, TypedArray typeArray) {
        ...
        int leftDrawable = typeArray.getResourceId(R.styleable.TitleAttr_left_text_drawable_left, R.drawable.back_black_icon);
        int rightDrawable = typeArray.getResourceId(R.styleable.TitleAttr_left_text_drawable_right, 0);
        mLeftBackTextTv.setCompoundDrawablePadding((int)getPixelSizeByDp(drawablePadding));
        mLeftBackTextTv.setCompoundDrawablesWithIntrinsicBounds(leftDrawable, 0, rightDrawable, 0);

        params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        mLeftBackTextTv.setPadding(getPixelSizeByDp(12),0,0,0);
     ...
     */
    private int getPixelSizeByDp(int dp) {
