 ...
 */
public class SlidingRightPaneLayout extends ViewGroup {
    ...
    public SlidingRightPaneLayout(@NonNull Context context) {
        this(context, null);
    }

    public SlidingRightPaneLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingRightPaneLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SlidingRightPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SlidingRightPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SlidingRightPaneLayout.this) {
