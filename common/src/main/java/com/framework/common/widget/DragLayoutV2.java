 ...
 */
@SuppressLint("NewApi")
public class DragLayoutV2 extends ViewGroup {
	...
	public DragLayoutV2(Context context, AttributeSet attrs, int defStyle) {
	...
	public void onProductSelected() {
		animTopOrBottom(frameView2, 120);
	}

	public void onDetailSelected() {
		animTopOrBottom(frameView1, -120);
	}
