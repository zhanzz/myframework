...
public class ZoomImageView extends androidx.appcompat.widget.AppCompatImageView implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //初始化的时候,我们要将图片居中显示
        //缩放比例
        float scale = Math.min(height*1.0f/dHeight,width*1.0f/dWidth);
        //初始化缩放比例
        mInitScale = scale;
        //最大缩放比例
